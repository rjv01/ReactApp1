  ...
  return (
    <Fragment>
      <Box sx={boxStyle} className='container'>
        <Paper sx={adFormArea} style={{backgroundColor: "#B3DDA3"}}>
          {/* Page title */}
          <Typography variant='h4'>List For Auction</Typography>
          <Alert />

          {/* Form */}
          <Box sx={formComponent}>
            <InputLabel className='il'>Product Name*</InputLabel>
            <TextField
              name='productName'
              onChange={(e) => {
                handleFormChange(e);
          ...
          <Box sx={formComponent}>
            <InputLabel className='il'>Description</InputLabel>
            <TextField
              name='description'
              multiline
          ...
          <Box sx={formComponent}>
            <InputLabel className='il'>Base Price*</InputLabel>
            <TextField
              name='basePrice'
              onChange={(e) => {
                handleFormChange(e);
          ...
          <Box sx={formComponent}>
            <InputLabel className='il'>Duration</InputLabel>
            <TextField
              name='duration'
              onChange={(e) => {
                handleFormChange(e);
          ...
          <Box sx={formComponent}>
            <InputLabel className='il'>Category</InputLabel>
            <TextField
              name='category'
              onChange={(e) => {
                handleFormChange(e);
          ...
          {uploading ? (
            ...
            <Box sx={formComponent}>
              <InputLabel className='il'>Upload image</InputLabel>
              <Input
                name='uploaded_file'
                type='file'
                id='imageFile'
